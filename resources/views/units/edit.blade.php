...
@section('title',"تعديل وحدة - ".   $unit->name)
@section('content')
    <div class="content">
                        ...
                        <div class="card-body">
                            <form action="{{route('units.update', $unit)}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="water_account" id="water_account" class="form-control" value="{{$unit['water_account']}}">
                                    <x-error name="water_account"></x-error>
                                </div>
                                <div class="form-group">
                                    <label for="electricity_account">حساب الكهرباء</label>
                                    <input type="text" name="electricity_account" id="electricity_account" class="form-control" value="{{$unit['electricity_account']}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="unit_type_id" id="unit_type_id" class="form-control">
                                        @foreach(\App\UnitType::all() as $item)
                                            <option {{$unit['unit_type_id'] == $item['id'] ? 'selected':''}} value="{{$item['id']}}">{{$item['name']}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="floor_id" id="floor_id" class="form-control">
                                        @foreach(\App\Floor::all() as $item)
                                            <option {{$unit['floor_id'] == $item['id'] ? 'selected':''}} value="{{$item['id']}}">{{$item['floor']}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="building_id" id="building_id" class="form-control">
                                        @foreach(\App\Building::all() as $item)
                                            <option {{$unit['building_id'] == $item['id'] ? 'selected':''}} value="{{$item['id']}}">{{$item['id']}}</option>
                                        @endforeach
                                    </select>

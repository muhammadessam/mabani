            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{route('income.income.update', $income)}}" method="post">
                                @csrf
                                @method('PUT')
                                <div class="form-group">
                                    ...
                                    <select name="cat_id" id="cat_id" class="form-control">
                                        @foreach(\App\IncomeCategory::all() as $item)
                                            <option {{$income['cat_id'] == $item['id'] ? 'selected':''}} value="{{$item['id']}}">{{$item['name']}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="building_id" id="building_id" class="form-control">
                                        @foreach(\App\Building::all() as $item)
                                            <option {{$income['building_id'] == $item['id'] ? 'selected':''}} value="{{$item['id']}}">{{$item['id']}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="unit_id" id="unit_id" class="form-control">
                                        @foreach(\App\Unit::all() as $item)
                                            <option {{$income['unit_id'] == $item['id'] ? 'selected':''}} value="{{$item['id']}}">{{$item['name']}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="date" name="date" id="date" value="{{$income['date']}}">
                                    <x-error name="date"></x-error>
                                </div>

                                <div class="form-group">
                                    <label for="amount">القيمة</label>
                                    <input class="form-control" type="text" name="amount" id="amount" value="{{$income['amount']}}">
                                    <x-error name="amount"></x-error>
                                </div>

                                <div class="form-group">
                                    <label for="paid">المدفوع</label>
                                    <input class="form-control" type="text" name="paid" id="paid" value="{{$income['paid']}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="note" id="note">{{$income['note']}}</textarea>

        ...
        <div style="direction: rtl">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li
                        class="nav-item has-treeview {{request()->routeIs('users.*')||request()->routeIs('roles.*') || request()->routeIs('permissions.*') ? 'menu-open' : ''}}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{route('permissions.index')}}"
                                    ...
                                    <p>الاذونات</p>
                                    <span
                                        class="badge-danger badge float-left">{{\App\Permission::all()->count()}}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li
                        class="nav-item has-treeview {{request()->routeIs('contracts.*')||request()->routeIs('units.*') || request()->routeIs('unit-types.*') ? 'menu-open' : ''}}">
                        <a href="#" class="nav-link ">
                    ...
                    <li
                        class="nav-item has-treeview {{request()->routeIs('income.*') || request()->routeIs('expenses.*') ? 'menu-open' : ''}}">
                        <a href="#" class="nav-link ">

                        ...
                        <div class="card-body">
                            <form action="{{route('owners.update', $owner)}}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" value="{{$owner->user['name']}}">
                                    <x-error name="name"></x-error>
                                </div>
                                <div class="form-group">
                                    <label for="phone">الهاتف</label>
                                    <input type="tel" name="phone" id="email" class="form-control" value="{{$owner->user['phone']}}">
                                    <x-error name="phone"></x-error>
                                </div>
                                <div class="form-group">
                                    <label for="email">الايميل</label>
                                    <input type="email" name="email" id="phone" class="form-control" value="{{$owner->user['email']}}">
                                    <x-error name="email"></x-error>
                                </div>
                                <div class="form-group">
                                    <label for="nationality">الجنسية</label>
                                    <input type="nationality" name="nationality" id="nationality" class="form-control" value="{{$owner->user['nationality']}}">

                            ...
                            <tr>
                                ...
                                <td class="d-flex">
                                    <a class="btn btn-flat btn-secondary ml-1" target="_blank"
                                        href="{{route('expenses.expense.print',$item)}}"><i class="fa fa-print"></i></a>
                                    <a class="btn btn-flat btn-primary ml-1"
                                        href="{{route('expenses.expense.edit',$item)}}"><i class="fa fa-edit"></i></a>
...
@endsection
@section('javascript')
<x-datatable id="incomes" print='1' cols=[0,1,2,3,4,5,6,7,8] header="" footer=""></x-datatable>
@endsection
